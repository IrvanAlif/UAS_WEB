...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .navbar-nav a:hover, .navbar-nav a.active { color: var(--primary); background: #eff6ff; }
        ...
        .search-input {
            ...
            padding: 7px 16px; font-size: 14px; width: 220px; outline: none;
        ...
        .carousel { position: relative; overflow: hidden; height: 480px; }
        ...
        .carousel-excerpt { color: rgba(255,255,255,.8); font-size: 15px; max-width: 560px; }
        .carousel-btn {
        ...
        .pill-label { font-size: 12px; font-weight: 600; color: var(--gray-500); text-transform: uppercase; letter-spacing: .8px; }
        .pill {
        ...
        .link-more { font-size: 14px; color: var(--primary); font-weight: 500; display: flex; align-items: center; gap: 4px; }
        ...
        .article-card-img-placeholder {
            width: 100%; height: 200px; background: linear-gradient(135deg, #dbeafe, #eff6ff);
        ...
        .article-card-date { font-size: 12px; color: var(--gray-500); margin-bottom: 6px; }
        .article-card-title {
            font-size: 16px; font-weight: 600; color: var(--gray-900);
            line-height: 1.4; margin-bottom: 8px;
        }
        .article-card-title:hover { color: var(--primary); }
        .article-card-excerpt { font-size: 13px; color: var(--gray-500); line-height: 1.5; }
...
<nav class="navbar">
    <div class="navbar-inner">
        ...
        <div class="navbar-right">
            ...
            @auth
                <a href="{{ route('admin.dashboard') }}" class="btn-subscribe">Admin Panel</a>
            @else
...
<footer>
    <div class="footer-inner">
        <div>
            ...
            <div class="footer-copy" style="margin-top:4px;">© {{ date('Y') }} TechNews Platform. All rights reserved.</div>
        </div>
...
(function() {
    ...
    document.querySelector('.carousel-btn.prev')?.addEventListener('click', () => { clearInterval(timer); go(current - 1); start(); });
    document.querySelector('.carousel-btn.next')?.addEventListener('click', () => { clearInterval(timer); go(current + 1); start(); });
