    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        :root {
            ...
            --sidebar-bg: #fff; --sidebar-w: 240px;
        ...
        .sidebar-nav a {
            ...
            color: var(--text-muted); transition: all .15s; margin-bottom: 4px;
        }
        ...
        .sidebar-footer a {
            display: flex; align-items: center; gap: 10px;
            padding: 10px 12px; border-radius: var(--radius); font-size: 14px; font-weight: 500;
            color: var(--text-muted); transition: all .15s; margin-bottom: 2px;
        }
        ...
        .topbar-search {
            ...
            font-size: 14px; outline: none; width: 220px; font-family: inherit;
        }
        ...
        .btn-new {
            ...
            border-radius: var(--radius); font-size: 14px; font-weight: 600; border: none; cursor: pointer;
        ...
        /* Table */
        .table-card { background: var(--sidebar-bg); border: 1px solid var(--border); border-radius: 12px; overflow: hidden; }
        .table-card-header {
        ...
        /* Forms */
        .form-card { background: var(--sidebar-bg); border: 1px solid var(--border); border-radius: 12px; padding: 32px; max-width: 760px; }
        ...
        .btn-secondary {
            ...
            border: 1.5px solid var(--border); border-radius: 8px; font-size: 14px; font-weight: 500;
        ...
        /* Pagination */
        .pagination { display: flex; gap: 4px; margin-top: 20px; justify-content: flex-end; }
        ...
        .admin-footer {
            ...
            display: flex; justify-content: space-between; align-items: center;
            font-size: 12px; color: var(--text-muted); background: var(--sidebar-bg);
        }
...
<div class="main">
    <div class="topbar">
        ...
        <div class="topbar-right">
            <input type="text" class="topbar-search" placeholder="Cari...">
            @yield('topbar-action')
        </div>
    </div>
